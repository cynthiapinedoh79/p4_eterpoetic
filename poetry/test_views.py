...
class PoetryViewTests(TestCase):
    ...
    def test_poem_detail_view_success(self):
        """Test that a valid poem slug
        returns 200 and the correct template/context."""
    ...
    def test_poem_detail_view_404(self):
        ...
        url = reverse(
            'poetry:poem_detail', args=['a-slug-that-does-not-exist'])
        response = self.client.get(url)
    ...
    def test_poem_list_view_default(self):
        """Test the /poems/ list page
        in its default state (showing collections)."""
    ...
    def test_list_view_all_poems(self):
        ...
        self.assertEqual(
            response.context['current_collection_slug'], 'all-poems')
